 ...
 */
public class BuyHandler extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            itemsManager.sellItem(itemID);
            Logger.getLogger(BuyHandler.class.getName()).log(Level.INFO, "Item is sold");

        } catch (SQLException | ClassNotFoundException | NamingException e) {
            Logger.getLogger(BuyHandler.class.getName()).log(Level.SEVERE, null, e);
        } finally {
            try {
        ...
        // если запрос не ajax, то перенаправляем
        String isFromAjax = request.getParameter("notdispatch");
        if (isFromAjax == null) {
